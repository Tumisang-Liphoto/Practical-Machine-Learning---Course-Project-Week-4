...
set.seed(10) # there will be some randomization thus we set a seed
...
```{r data partitioning}
trainingData <- createDataPartition(y=training$classe, p=0.7, list=F)
...
trainingData1 <- trainingData1[, -(1:7)]
trainingData2 <- trainingData2[, -(1:7)]
dim(trainingData1)
dim(trainingData2)
```
